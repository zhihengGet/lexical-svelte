<script context="module" lang="ts">
	...
	import type { MenuRenderFn } from '@lexical/react/LexicalNodeMenuPlugin.svelte';
	import {
	...
	> {
		...
		insertNode: (editor: lexical.LexicalEditor, result: TEmbedMatchResult) => void;
	}
	...
	export const INSERT_EMBED_COMMAND: lexical.LexicalCommand<EmbedConfig['type']> =
