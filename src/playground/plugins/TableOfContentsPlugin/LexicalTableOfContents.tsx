...
import {useLexicalComposerContext} from '@lexical/react/LexicalComposerContext.svelte.svelte';
import {$isHeadingNode as isHeadingNode as isHeadingNode, HeadingNode, HeadingTagType} from '@lexical/rich-text';
import {$getNodeByKey as getNodeByKey as getNodeByKey, $getRoot as getRoot as getRoot, TextNode} from 'lexical';
