...
<script lang="ts">
	...
	import { $isInlineImageNode as isInlineImageNode } from './InlineImageNode.svelte';
	...
	let { src, altText, nodeKey, width, height, showCaption, caption, position } = $props<{
		altText: string;
...
<div {draggable}>
	<button class="image-edit-button" bind:this={buttonRef.current}> Edit </button>
	<img
		class={isFocused() ? `focused ${lexical.$isNodeSelection(selection) ? 'draggable' : ''}` : null}
		{src}
		alt={altText}
...
<div class="image-caption-container">
	<LexicalNestedComposer initialEditor={caption}>
		...
		<RichTextPlugin
			...
			contentEditable={ContentEditableS}
